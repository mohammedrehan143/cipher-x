...
> **Project:** CIPHER-X  
> **Last Updated:** 2026-08-20 (Unified 4-Person Guide)
...
|---|---|---|
| Python | 3.10+ | 3.11 / 3.12 / 3.14 compatible |
...
```
[Person 1] python run_pipeline.py
    │
    ▼
[Person 2] python run_vectorize.py --min-area 1000
    │
    ▼
[Person 3] python run_classify.py
    │
    ▼
